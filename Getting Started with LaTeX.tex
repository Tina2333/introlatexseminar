...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{c|c} %l:left r: right c:center
			\textbf{\LaTeX Command} & \textbf{Result} \\ \hline %put a line after this
...
\end{figure}
	...
	\begin{thebibliography}{99} %99 is the maximium amount of citation 
